...
// // // import { UserCarsContext } from '../Context/UserCarsContext'; 
// // // // ADDED
...
// //     .navtheme-usercar-price { color: #7ee8a7; font-size: 14px; font-weight: 600; margin: 0; }
...
// import { UserContext } from '../Context/UserContext';
// import EditProfileModal from './EditProfileModal';
// // import UpdateCarModal from './UpdateCarModal'; // ADDED: modal for editing/deleting a single car
...
//     const navigate = useNavigate();
//     const { id: paramId } = useParams();
//     // const {deleteCar}=useContext(CarUpdateContext);
...
//     // ADDED: which car (if any) is currently being edited, and whether that modal is open
...
//                                     {/* ADDED: only the owner can edit their own listed cars */}
//                                     {isOwnProfile && (
//                                         <div className="navtheme-usercar-actions">
//                                             <Button
//                                                 size="sm"
//                                                 className="navtheme-btn-outline w-100"
...
//             {/* ADDED: edit/delete modal for a single car, reuses CarUpdateContext */}
//             <UpdateCarModal
//                 show={showCarModal}
//                 onHide={closeEditCar}
//                 car={selectedCar}
...
function Profile() {
    ...
    // ADDED: tracks the _id of the car currently being deleted from the card's quick-delete
    // button, so we can disable just that card's buttons / show a "Deleting..." state
    // instead of disabling every card in the grid at once.
