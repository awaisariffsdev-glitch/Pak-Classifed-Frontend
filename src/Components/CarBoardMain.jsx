...
//                                 }}
//                             >
//                                 {/* ADDED: whole card body is now a Link to the car's details page */}
...
//                 /* ADDED: makes the whole clickable area behave like the old plain div,
//                    with no link underline/color changes */
//                 .cbm-card-link {
//                     display: block;
//                     text-decoration: none;
//                     color: inherit;
...
const CarBoardMain = ({ showAll = true }) => {
    ...
    return (
        <div className="cbm-page">
            {/* ADDED: container matches Categories' .cat-section exactly —
                same max-width and same side padding — so both sections'
                left/right edges line up on the page instead of drifting
                based on which one owns the max-width/padding. */}
            ...
            <style>{`
                ...
                /* ADDED: mirrors .cat-section from Categories.jsx —
                   same max-width (1200px) and side padding (20px / 16px mobile) */
                .cbm-container {
                    max-width: 1200px;
                    margin: 0 auto;
                    padding: 0 20px;
